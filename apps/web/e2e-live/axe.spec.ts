// Live-lane axe pass: the populated authenticated surfaces the offline
// suite cannot render honestly (/portfolio, /validators/mine, /admin).
// Runs on the scheduled lane; skip-clean without a key.

// CO-23 as assertions (8.3 §3.2; invariant 2): every labeled shell,
// cold-start, below-threshold and degraded state is VISIBLE IN THE
// ACCESSIBILITY TREE — never an aria-hidden gap, never blank — and passes axe
// in both themes. These are the D22 honesty surfaces: on a publicly reachable
// pilot, an inaccessible caveat is a caveat that does not exist for AT users.
